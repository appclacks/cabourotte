...
Cabourotte is a tool which allow you to execute healthchecks (HTTP(s), TCP, DNS, TLS, arbitrary commands) on your infrastructure. It already supports various features including:
